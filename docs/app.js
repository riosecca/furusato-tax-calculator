...
function initTabs(buttonSelector = '.tab-button', panelSelector = '.panel') {
  ...
  tabButtons.forEach((button) => {
    button.addEventListener('click', () => {
      ...
      const eventDetail = {
        id: targetId !== null && targetId !== void 0 ? targetId : null,
      };
      document.dispatchEvent(
        new CustomEvent('tab:changed', { detail: eventDetail })
      );
    });
  });
}
...
function buildAdvancedDefaults(simpleState) {
  ...
  const incomeSelection = Number(
    (_a =
      simpleState === null || simpleState === void 0
        ? void 0
        : simpleState.income) !== null && _a !== void 0
      ? _a
      : defaultSimpleState.income
  );
  ...
  const socialBracket =
    (_b = SOCIAL_INSURANCE_ESTIMATES.find(({ max }) => annualIncome <= max)) !==
      null && _b !== void 0
      ? _b
      : SOCIAL_INSURANCE_ESTIMATES[SOCIAL_INSURANCE_ESTIMATES.length - 1];
  defaults['adv-social'] = String(
...
function buildAdvancedPreset(simpleState) {
  ...
  const annualIncome = Number.isFinite(income)
    ? Math.max(Math.round(income * MAN_YEN), 0)
    : null;
  const hasSpouse = simpleState.family !== 'single';
  const hasDependents =
    simpleState.family === 'couple-child' || simpleState.family === 'extended';
  const socialBracket =
    annualIncome !== null
      ? (_a = SOCIAL_INSURANCE_ESTIMATES.find(
          ({ max }) => annualIncome <= max
  ...
  return {
    ...
    'adv-family-type':
      simpleState.family === 'couple' || simpleState.family === 'couple-child'
        ? 'couple'
        : 'none',
...
function initAdvancedSimulator() {
  ...
  const renderMoneyPopover = (input, amount, visible) => {
    ...
    const parent =
      (_a =
        input === null || input === void 0 ? void 0 : input.parentElement) !==
        null && _a !== void 0
        ? _a
        : null;
    if (!parent) {
  ...
  const enhanceMoneyInputs = () => {
    ADVANCED_MONEY_INPUT_IDS.forEach((id) => {
      ...
      input.placeholder =
        (_a = input.placeholder) !== null && _a !== void 0 ? _a : '0';
      input.addEventListener('focus', () =>
        syncMoneyInput(input, { showPopover: true })
      );
  ...
  const applyAdvancedState = (state, { preferExisting = false } = {}) => {
    ...
    ADVANCED_INPUT_IDS.forEach((id) => {
      ...
      if (
        ...
        ADVANCED_MONEY_INPUT_ID_SET.has(id)
      ) {
  ...
  const calculateAdvanced = () => {
    ...
    const familyType =
      (_a =
        familyTypeSelect === null || familyTypeSelect === void 0
          ? void 0
          : familyTypeSelect.value) !== null && _a !== void 0
        ? _a
        : 'none';
    const hasSpouse =
      (advancedSpouseSelect === null || advancedSpouseSelect === void 0
        ? void 0
        : advancedSpouseSelect.value) === 'has';
    ...
    const spouseDeduction =
      hasSpouse && spouseIncome <= 1060000 ? ADV_SPOUSE_DEDUCTION : 0;
    ...
    advancedDetail.textContent = `${
      hasSpouse ? '配偶者あり' : '配偶者なし'
    } / ${dependents}人扶養 / 課税所得${formatYen(
      taxableRounded
    )} をもとに試算しています`;
  ...
  advancedForm === null || advancedForm === void 0
    ? void 0
  ...
  const advancedInitialState = Object.assign(
    {},
  ...
  advancedTab === null || advancedTab === void 0
    ? void 0
  ...
  document.addEventListener('simple:state-updated', (event) => {
    ...
    applySimplePreset(
      simpleState !== null && simpleState !== void 0 ? simpleState : null
    );
  });
}
...
function initTabToggleCta() {
  ...
  cta.addEventListener('click', (event) => {
    ...
    event.preventDefault();
    const targetId =
      (_a = cta.dataset.nextTab) !== null && _a !== void 0
        ? _a
        : advancedPanelId;
  ...
  document.addEventListener('tab:changed', (event) => {
    ...
    updateCta(
      (_a = detail === null || detail === void 0 ? void 0 : detail.id) !==
        null && _a !== void 0
        ? _a
        : null
    );
  ...
  updateCta(
    (_a =
      initialActive === null || initialActive === void 0
        ? void 0
        : initialActive.dataset.target) !== null && _a !== void 0
      ? _a
      : null
  );
}
function initModeSwitch() {
  ...
  const buttons = Array.from(
    document.querySelectorAll('[data-role="mode-switch"]')
  );
  if (!buttons.length) {
    return;
  }
  ...
  const initialActive =
    (_b =
      (_a = document.querySelector('.tab-button.tab-active')) === null ||
      _a === void 0
        ? void 0
        : _a.dataset.target) !== null && _b !== void 0
      ? _b
      : null;
...
function initBarActions() {
  ...
  let activePanelId =
    findActivePanel() !== null && findActivePanel() !== void 0
      ? findActivePanel()
      : 'panel-simple';
  const updateCalcLabel = () => {
    var _a;
    const isAdvanced = activePanelId === 'panel-advanced';
    (_a = calcButton) === null || _a === void 0
      ? void 0
      : (_a.textContent = isAdvanced ? '計算する' : '計算する');
  };
  calcButton === null || calcButton === void 0
    ? void 0
    : calcButton.addEventListener('click', () => {
        const eventName =
          activePanelId === 'panel-advanced'
            ? 'simulator:advanced-calc'
            : 'simulator:simple-calc';
