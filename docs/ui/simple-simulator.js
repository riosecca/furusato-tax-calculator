...
export function initSimpleSimulator() {
  ...
  const getSelectedValue = (name) => {
    var _a, _b;
    return (_b =
      (_a = getSelectedInput(name)) === null || _a === void 0
        ? void 0
  ...
  const hasSpouseDeduction = (family) =>
  ...
  const estimateSocialInsurance = (annualIncome) => {
    var _a;
    const bracket =
      (_a = SOCIAL_INSURANCE_ESTIMATES.find(
  ...
  function runSimpleSimulation() {
    ...
    document.dispatchEvent(
      new CustomEvent('simple:state-updated', {
        detail: stateToSave,
      })
    );
    ...
    const incomeBase =
      (_a = baseEstimates[selectedIncome]) !== null && _a !== void 0 ? _a : 0;
    const adjustment =
      (_b = familyAdjustments[selectedFamily]) !== null && _b !== void 0
        ? _b
        : 0;
  ...
  calcButton === null || calcButton === void 0
    ? void 0
